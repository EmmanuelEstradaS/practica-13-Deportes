          ...
          <div class="card">
            <div class="card-header">
              <div class="float-left">
                <a href="index.php?action=agregar_equipo" class="btn btn-success" title="Agregar deporte">
            ...
            <div class="card-body">
                  <?php
                    ...
                    $vistaEquipo = new MvcController();
                    $vistaEquipo -> vistaEquipoController();
                    $vistaEquipo -> borrarDeporteController();
                  ?>
            </div>
            <!-- /.card-body -->
          </div>
