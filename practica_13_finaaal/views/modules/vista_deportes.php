...
<head>
  ...
  <title>Listado de desportes</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Listado de deportes</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            <div class="card-header">
              <div class="float-left">
                <a href="index.php?action=agregar_deporte" class="btn btn-success" title="Agregar deporte">
            ...
            <div class="card-body">
                  <?php
                    ...
                    $vistaDeporte = new MvcController();
                    $vistaDeporte -> vistaDeporteController();
                    $vistaDeporte -> borrarDeporteController();
                  ?>
            </div>
            <!-- /.card-body -->
          </div>
