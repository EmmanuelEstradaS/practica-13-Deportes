        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Listado de Jugadores</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            <div class="card-header">
              <div class="float-left">
                <a href="index.php?action=agregar_jugador" class="btn btn-success" title="Agregar libro">
            ...
            <div class="card-body">
                  <?php
                    ...
                    $vistaLibro -> vistaJugadoresController();
